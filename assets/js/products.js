...
const products = [
  ...
  // ============================
  {
    ...
    specs: [
      ...
      { label: 'Battery', value: '4685mAh, up to 33h video' },
      { label: 'Camera', value: '48MP + 48MP + 12MP' },
      { label: 'Weight', value: '227g' },
      { label: 'OS', value: 'iOS 20' }
    ],
    videoId: 'qRw9z_nQmeQ',
  ...
  },
  {
    ...
    specs: [
      ...
      { label: 'OS', value: 'Android 16, One UI 7' }
    ],
    videoId: 'Hw4N0X2JH_M',
    affiliateLink: 'https://amazon.com/dp/EXAMPLE?tag=affiliateglobal-20',
    badge: 'Best Seller'
  },
  {
    ...
    specs: [
      ...
      { label: 'Camera', value: '64MP + 48MP + 48MP' },
      { label: 'Weight', value: '207g' },
  ...
  },
  {
    ...
    specs: [
      { label: 'Display', value: '6.73" AMOLED LTPO, 120Hz' },
      { label: 'Processor', value: 'Snapdragon 8 Gen 4' },
      { label: 'RAM', value: '12GB / 16GB' },
      { label: 'Storage', value: '256GB / 512GB' },
      { label: 'Battery', value: '5400mAh, 120W charging' },
      { label: 'Camera', value: '50MP + 50MP + 50MP Leica' },
      { label: 'Weight', value: '213g' },
      { label: 'OS', value: 'HyperOS 2 (Android 16)' }
    ],
    videoId: 'kLp0UeXNzHc',
    affiliateLink: 'https://amazon.com/dp/EXAMPLE?tag=affiliateglobal-20',
    badge: 'Sale'
  },
  {
    ...
    specs: [
      ...
      { label: 'Processor', value: 'A18 (3nm)' },
      { label: 'RAM', value: '8GB' },
      { label: 'Storage', value: '128GB / 256GB / 512GB' },
      { label: 'Battery', value: '3561mAh, up to 22h video' },
  ...
  },
  {
    ...
    specs: [
      ...
      { label: 'RAM', value: '12GB' },
      { label: 'Storage', value: '256GB / 512GB' },
      { label: 'Battery', value: '4900mAh, 45W charging' },
  ...
  },
  {
    ...
    specs: [
      ...
      { label: 'Battery', value: '4600mAh' },
      { label: 'Camera', value: '64MP + 12MP' },
  ...
  // ============================
  {
    ...
    specs: [
      ...
      { label: 'Processor', value: 'Apple M4 Max (16C CPU, 40C GPU)' },
      { label: 'RAM', value: '48GB unified memory' },
      { label: 'Storage', value: '1TB SSD' },
      { label: 'Battery', value: 'Up to 22 hours' },
      { label: 'Ports', value: '3× Thunderbolt 5, HDMI 2.1, SDXC, MagSafe 3' },
      { label: 'Weight', value: '2.14 kg' },
      { label: 'OS', value: 'macOS 16' }
    ],
    videoId: 'RrZm2CxYYOo',
    affiliateLink: 'https://amazon.com/dp/EXAMPLE?tag=affiliateglobal-20',
    badge: 'Best Seller'
  },
  {
    ...
    specs: [
      { label: 'Display', value: '16.3" 4K+ OLED InfinityEdge touch' },
      { label: 'Processor', value: 'Intel Core Ultra 9 285H' },
      { label: 'GPU', value: 'NVIDIA RTX 5070 Ti 12GB' },
  ...
  },
  {
    ...
    specs: [
      ...
      { label: 'Processor', value: 'Apple M4 (10C CPU, 10C GPU)' },
      { label: 'RAM', value: '16GB unified memory' },
      { label: 'Storage', value: '512GB SSD' },
      { label: 'Battery', value: 'Up to 18 hours' },
      { label: 'Ports', value: '2× Thunderbolt 4, MagSafe 3, 3.5mm' },
  ...
  },
  {
    ...
    specs: [
      { label: 'Display', value: '14" 2.8K OLED, 100% DCI-P3' },
      { label: 'Processor', value: 'Intel Core Ultra 7 265U' },
      { label: 'RAM', value: '16GB LPDDR5X' },
      { label: 'Storage', value: '512GB SSD' },
      { label: 'Battery', value: 'Up to 16 hours' },
      { label: 'Weight', value: '0.95 kg (2.1 lbs)' },
  ...
  },
  {
    ...
    specs: [
      { label: 'Display', value: '16" QHD+ OLED, 240Hz, 0.2ms' },
      { label: 'Processor', value: 'AMD Ryzen AI 9 HX 370' },
      { label: 'GPU', value: 'NVIDIA RTX 5080 16GB' },
      { label: 'RAM', value: '32GB DDR5' },
      { label: 'Storage', value: '1TB PCIe 5.0 SSD' },
      { label: 'Battery', value: '90Wh, 100W USB-C charging' },
  ...
  },
  {
    ...
    specs: [
      { label: 'Display', value: '16" 3K+ OLED touch, 100% DCI-P3' },
      { label: 'Processor', value: 'Intel Core Ultra 7 265H' },
      { label: 'RAM', value: '16GB LPDDR5X' },
      { label: 'Storage', value: '1TB SSD' },
      { label: 'Battery', value: 'Up to 15 hours' },
      { label: 'Weight', value: '1.62 kg' },
      { label: 'Features', value: '360° hinge, HP MPP2.0 pen included' },
      { label: 'OS', value: 'Windows 11 Home' }
    ],
    videoId: 'KOYiWVJ9Ooo',
    affiliateLink: 'https://amazon.com/dp/EXAMPLE?tag=affiliateglobal-20',
  ...
  },
  {
    ...
    specs: [
      { label: 'Display', value: '16" Dynamic AMOLED 2X touch, 120Hz' },
      { label: 'Processor', value: 'Intel Core Ultra 7 265H' },
      { label: 'RAM', value: '16GB LPDDR5X' },
      { label: 'Storage', value: '512GB SSD' },
      { label: 'Battery', value: 'Up to 21 hours' },
      { label: 'Weight', value: '1.54 kg' },
      { label: 'Features', value: 'S Pen included, 360° hinge' },
      { label: 'OS', value: 'Windows 11 Home' }
    ],
    videoId: 'q7U_KBz5Xpg',
    affiliateLink: 'https://amazon.com/dp/EXAMPLE?tag=affiliateglobal-20',
  ...
  // ============================
  {
    ...
    specs: [
      ...
      { label: 'Processor', value: 'Apple M4 (10C GPU)' },
      { label: 'RAM', value: '8GB / 16GB' },
      { label: 'Storage', value: '256GB / 512GB / 1TB / 2TB' },
      { label: 'Battery', value: 'Up to 10 hours' },
      { label: 'Camera', value: '12MP + 12MP, LiDAR' },
      { label: 'Weight', value: '579g (Wi-Fi)' },
  ...
  },
  {
    ...
    specs: [
      ...
      { label: 'Processor', value: 'Apple M3 (9C GPU)' },
      { label: 'RAM', value: '8GB' },
      { label: 'Storage', value: '128GB / 256GB / 512GB' },
      { label: 'Battery', value: 'Up to 10 hours' },
      { label: 'Camera', value: '12MP wide, Center Stage' },
      { label: 'Weight', value: '462g (Wi-Fi)' },
      { label: 'OS', value: 'iPadOS 19' }
    ],
    videoId: '9ChG88t5BSM',
    affiliateLink: 'https://amazon.com/dp/EXAMPLE?tag=affiliateglobal-20',
  ...
  },
  {
    ...
    specs: [
      ...
      { label: 'RAM', value: '12GB / 16GB' },
      { label: 'Storage', value: '256GB / 512GB / 1TB' },
      { label: 'Battery', value: '11200mAh, 45W charging' },
      { label: 'Camera', value: '13MP + 8MP rear, 12MP + 12MP front' },
      { label: 'Weight', value: '718g (Wi-Fi)' },
      { label: 'OS', value: 'Android 16, One UI 7' }
    ],
    videoId: 'm4Krl6Lc0e4',
    affiliateLink: 'https://amazon.com/dp/EXAMPLE?tag=affiliateglobal-20',
  ...
  },
  {
    ...
    specs: [
      { label: 'Display', value: '11" LCD, 2560×1600, 120Hz' },
      { label: 'Processor', value: 'Google Tensor G4' },
      { label: 'RAM', value: '8GB' },
      { label: 'Storage', value: '128GB / 256GB' },
      { label: 'Battery', value: 'Up to 12 hours' },
      { label: 'Camera', value: '8MP front + 8MP rear' },
      { label: 'Weight', value: '499g' },
      { label: 'OS', value: 'Android 16' }
    ],
    videoId: 'T7CQjXu3M_Q',
    affiliateLink: 'https://amazon.com/dp/EXAMPLE?tag=affiliateglobal-20',
  ...
  // ============================
  {
    ...
    specs: [
      { label: 'Driver', value: 'Custom low-distortion driver' },
      { label: 'Chip', value: 'Apple H3' },
      { label: 'ANC', value: 'Active Noise Cancellation 2.0' },
      { label: 'Audio', value: 'Personalized Spatial Audio with head tracking' },
      { label: 'Battery', value: '8h (36h with case)' },
  ...
  },
  {
    ...
    specs: [
      ...
      { label: 'Chip', value: 'HD Noise Canceling Processor QN2' },
      { label: 'ANC', value: 'Adaptive Noise Cancellation' },
      { label: 'Audio', value: 'Hi-Res Audio Wireless (LDAC), DSEE Extreme' },
      { label: 'Battery', value: '30 hours' },
      { label: 'Charging', value: 'USB-C, 5 min = 5 hours' },
  ...
  },
  {
    ...
    specs: [
      { label: 'Driver', value: 'Custom Bose transducer' },
      { label: 'ANC', value: 'CustomTune adaptive ANC' },
      { label: 'Audio', value: 'Bose Immersive Audio with head tracking' },
      { label: 'Battery', value: '24 hours' },
      { label: 'Charging', value: 'USB-C, 15 min = 2.5 hours' },
      { label: 'Bluetooth', value: '5.3, Multipoint' },
      { label: 'Weight', value: '167g (5.9 oz)' },
      { label: 'Features', value: 'SimpleSync with Bose soundbars' }
    ],
    videoId: '2UJgJ8kAGgg',
    affiliateLink: 'https://amazon.com/dp/EXAMPLE?tag=affiliateglobal-20',
    badge: null
  },
  {
    ...
    specs: [
      { label: 'Driver', value: '2-way coaxial speakers' },
      { label: 'Amplifier', value: 'Dual amplifiers' },
      { label: 'ANC', value: 'Intelligent Active Noise Cancellation' },
      { label: 'Audio', value: '360 Audio with head tracking' },
      { label: 'Battery', value: '7h (29h with case)' },
      { label: 'Charging', value: 'Wireless charging, Qi2' },
  ...
  },
  {
    ...
    specs: [
      ...
      { label: 'Audio', value: 'Gemini AI integration' },
      { label: 'Battery', value: '7h (27h with case)' },
  ...
  },
  {
    ...
    specs: [
      { label: 'Driver', value: '8.4mm driver' },
      { label: 'Chip', value: 'Integrated Processor V2' },
      { label: 'ANC', value: 'Auto NC Optimizer' },
      { label: 'Audio', value: 'Hi-Res Audio Wireless (LDAC)' },
      { label: 'Battery', value: '9h (30h with case)' },
  ...
  // ============================
  {
    ...
    specs: [
      { label: 'Display', value: '49mm, Always-On Retina LTPO3' },
      { label: 'Processor', value: 'Apple S10 SiP' },
      { label: 'GPS', value: 'Dual-frequency (L1 + L5)' },
      { label: 'Water Resistance', value: '100m (EN13319)' },
      { label: 'Battery', value: 'Up to 72h (36h normal)' },
      { label: 'Sensors', value: 'ECG, SpO2, temperature, depth' },
      { label: 'Weight', value: '61.4g (titanium)' },
  ...
  },
  {
    ...
    specs: [
      { label: 'Display', value: 'Always-On Retina LTPO3' },
      { label: 'Processor', value: 'Apple S10 SiP' },
      { label: 'Sensors', value: 'ECG, SpO2, temperature' },
      { label: 'Water Resistance', value: '50m (WR50)' },
      { label: 'Battery', value: 'Up to 18h (36h low power)' },
      { label: 'Charging', value: '0-80% in 30 min' },
      { label: 'Weight', value: '36.4g (aluminium, 45mm)' },
      { label: 'OS', value: 'watchOS 11' }
    ],
    videoId: 'YQETpRgV55c',
    affiliateLink: 'https://amazon.com/dp/EXAMPLE?tag=affiliateglobal-20',
  ...
  },
  {
    ...
    specs: [
      { label: 'Display', value: '47mm Super AMOLED, Sapphire Crystal' },
      { label: 'Processor', value: 'Exynos W1000 (3nm)' },
      { label: 'GPS', value: 'Dual-frequency (L1 + L5)' },
      { label: 'Water Resistance', value: '10ATM + IP68' },
      { label: 'Battery', value: 'Up to 60h (100h power saving)' },
      { label: 'Sensors', value: 'BioActive Sensor 2, ECG, BIA' },
      { label: 'Weight', value: '60.5g (titanium)' },
  ...
  },
  {
    ...
    specs: [
      { label: 'Display', value: '1.4" AMOLED, always-on option' },
      { label: 'GPS', value: 'Multi-band GNSS, SatIQ' },
      { label: 'Solar', value: 'Power Sapphire solar charging' },
      { label: 'Water Resistance', value: '10 ATM, MIL-STD-810' },
      { label: 'Battery', value: 'Up to 29 days (smartwatch)' },
      { label: 'Maps', value: 'TopoActive maps' },
      { label: 'Weight', value: '88g (titanium)' },
      { label: 'Sensors', value: 'Elevate v5 HR, Pulse Ox, compass' }
    ],
    videoId: 'qlGJvU8GpeM',
    affiliateLink: 'https://amazon.com/dp/EXAMPLE?tag=affiliateglobal-20',
    badge: null
  },
  {
    ...
    specs: [
      { label: 'Display', value: '45mm Actua AMOLED, 2000 nits' },
      { label: 'Processor', value: 'Tensor W3 + Cortex coprocessor' },
      { label: 'Sensors', value: 'ECG, SpO2, multi-path HR, temperature' },
      { label: 'Water Resistance', value: '5 ATM' },
      { label: 'Battery', value: 'Up to 36h (AOD off)' },
      { label: 'Charging', value: 'Fast charging, 0-80% in 30 min' },
      { label: 'Weight', value: '37g (no band)' },
  ...
  },
  {
    ...
    specs: [
      ...
      { label: 'Sensors', value: 'HR, stress, skin temp, sleep' },
      { label: 'Sizes', value: '7 sizes (5–13)' },
      { label: 'Weight', value: '2.3g–3.0g (varies by size)' },
      { label: 'AI Features', value: 'Galaxy AI Energy Score, Booster Card' },
      { label: 'Compatibility', value: 'Samsung Health, Android' }
    ],
    videoId: 'TNFko0QpElI',
    affiliateLink: 'https://amazon.com/dp/EXAMPLE?tag=affiliateglobal-20',
    badge: null
  ...
  // ============================
  {
    ...
    specs: [
      { label: 'Compatibility', value: 'iPad Pro M4 13" and 11"' },
      { label: 'Keyboard', value: 'Backlit scissor mechanism' },
      { label: 'Trackpad', value: 'Haptic feedback' },
      { label: 'Design', value: 'Floating cantilever' },
      { label: 'Ports', value: 'USB-C pass-through' },
      { label: 'Weight', value: '605g (13" version)' },
      { label: 'Colors', value: 'Black, White' },
      { label: 'Features', value: 'Function row, two viewing angles' }
    ],
    videoId: 'bOXU3MqePbQ',
    affiliateLink: 'https://amazon.com/dp/EXAMPLE?tag=affiliateglobal-20',
    badge: null
  },
  {
    ...
    specs: [
      { label: 'Driver', value: 'AKG-tuned 2-way speakers' },
      { label: 'ANC', value: 'Adaptive Active Noise Cancellation' },
      { label: 'Audio', value: 'Galaxy AI integration' },
      { label: 'Battery', value: '6h (26h with case)' },
      { label: 'Charging', value: 'Wireless charging case' },
      { label: 'Water Resistance', value: 'IP57' },
      { label: 'Bluetooth', value: '5.4, multi-device' },
      { label: 'Weight', value: '5.0g per earbud' }
    ],
    videoId: '8j9b8_1R_vI',
    affiliateLink: 'https://amazon.com/dp/EXAMPLE?tag=affiliateglobal-20',
    badge: 'Sale'
  },
  {
    ...
    specs: [
      { label: 'Connectivity', value: 'Bluetooth, UWB, NFC' },
      { label: 'Network', value: 'Find My (hundreds of millions)' },
      { label: 'Battery', value: 'CR2032, 1+ year' },
      { label: 'Water Resistance', value: 'IP67' },
      { label: 'Precision Finding', value: 'Ultra Wideband' },
      { label: 'Quantity', value: '4-pack' },
      { label: 'Weight', value: '11g each' },
      { label: 'Customization', value: 'Free engraving' }
    ],
    videoId: 'G5R3PfpScQA',
    affiliateLink: 'https://amazon.com/dp/EXAMPLE?tag=affiliateglobal-20',
    badge: 'Best Seller'
  },
  {
    ...
    specs: [
      { label: 'iPhone Charging', value: 'Qi2 15W MagSafe' },
      { label: 'Apple Watch', value: 'Fast charge module' },
      { label: 'AirPods', value: '5W charging pad' },
      { label: 'Design', value: 'Weighted base, LED indicator' },
      { label: 'Adapter', value: 'USB-C power adapter included' },
      { label: 'Colors', value: 'Black, White' },
      { label: 'Dimensions', value: 'Compact desktop design' },
      { label: 'Features', value: 'MagSafe-compatible alignment' }
    ],
    videoId: 'QnqyX6Fs2Rc',
    affiliateLink: 'https://amazon.com/dp/EXAMPLE?tag=affiliateglobal-20',
    badge: null
  },
  {
    ...
    specs: [
      { label: 'Compatibility', value: 'Galaxy Watch7 Ultra 47mm' },
      { label: 'Material', value: 'Fluoroelastomer' },
      { label: 'Closure', value: 'Magnetic D-Buckle' },
      { label: 'System', value: 'Quick-release spring bars' },
      { label: 'Water Resistance', value: 'Sweat and water resistant' },
      { label: 'Colors', value: 'Gray, Orange, Green' }
    ],
    videoId: 'TtKRtn60SLc',
    affiliateLink: 'https://amazon.com/dp/EXAMPLE?tag=affiliateglobal-20',
    badge: null
  },
  {
    ...
    specs: [
      { label: 'Power Output', value: '65W USB-C PD 3.0' },
      { label: 'Technology', value: 'GaN (gallium nitride)' },
      { label: 'Charging', value: 'Super Fast Charging 2.0' },
      { label: 'Cable', value: '1.8m USB-C to USB-C included' },
      { label: 'Compatibility', value: 'Galaxy Book, phones, tablets' },
      { label: 'Safety', value: 'Overheat protection' },
      { label: 'Plug', value: 'Foldable design' },
      { label: 'Dimensions', value: 'Compact GaN design' }
    ],
    videoId: '0RMYbC0UfAU',
    affiliateLink: 'https://amazon.com/dp/EXAMPLE?tag=affiliateglobal-20',
    badge: 'Sale'
  },
  {
    ...
    specs: [
      { label: 'Compatibility', value: 'iPad Pro 12.9" (2018–2022)' },
      { label: 'Keyboard', value: 'Backlit 7-color' },
      { label: 'Trackpad', value: 'Built-in' },
      { label: 'Battery', value: 'Up to 200 hours' },
      { label: 'Charging', value: 'USB-C' },
      { label: 'Stand', value: 'Multi-angle viewing' },
      { label: 'Features', value: 'Apple Pencil holder, sleep/wake cover' },
      { label: 'Protection', value: 'Shockproof hardshell back' }
    ],
    videoId: 'dbqaqaV1-pc',
    affiliateLink: 'https://amazon.com/dp/EXAMPLE?tag=affiliateglobal-20',
    badge: null
